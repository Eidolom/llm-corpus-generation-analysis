...
\WarningFilter{latex}{First Aid for listings.sty no longer applied!}
...
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, backgrounds, shadows}
\urlstyle{same}
...
\renewcommand*{\bibfont}{\normalfont} % Change to normal font instead of singlespacing
