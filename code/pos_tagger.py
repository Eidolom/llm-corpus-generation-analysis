...
class POSTagger:
    ...
    def __init__(self, json_file: str = 'intermediate_sentences.json'):
        """
    ...
    def export_results(self, output_file: str = 'pos_tagging_results.json') -> bool:
        """
...
def main():
    ...
    # Initialize tagger
    tagger = POSTagger('intermediate_sentences.json')
    ...
    # Export results
    tagger.export_results('pos_tagging_results.json')
